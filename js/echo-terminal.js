(function () {
  ...
  const FALLBACK_REPLIES = [
    //---------------50 fallback---------//
    "✨ এইটা আমার ডেটাবেসে নাই! Razu-র স্কিল, প্রজেক্ট বা এক্সপেরিয়েন্স নিয়ে জিজ্ঞেস করো।",
    "✨ মাথা চুলকাচ্ছি... থুক্কু, আমার তো মাথাই নাই! স্কিল, প্রজেক্ট বা কন্ট্যাক্ট নিয়ে জিজ্ঞেস করো।",
    "✨ এই প্রশ্নে আমার সার্কিট শর্ট খেয়ে গেছে! Razu-র কাজ নিয়ে কিছু জিজ্ঞেস করো তো।",
    "✨ 404: উত্তর খুঁজে পাওয়া যায়নি! স্কিল বা প্রজেক্ট নিয়ে ট্রাই করো।",
    "✨ এইটা বুঝিনি, বস। Razu-র এডুকেশন, স্কিল বা কন্ট্যাক্ট নিয়ে জিজ্ঞেস করলে সহজ হবে।",
    "✨ আমি Echo, জ্যোতিষী না! Razu-র প্রজেক্ট বা এক্সপেরিয়েন্স নিয়ে জিজ্ঞেস করো।",
    "✨ হোয়াট? আরেকবার সহজ করে বলো তো, বুঝলাম না।",
    "✨ এই টপিকটা আমার নলেজ বেসে লোড হয়নি! স্কিল বা প্রজেক্ট দিয়ে শুরু করি?",
    "✨ আমার ব্রেইন (মানে কোড) এইটা প্রসেস করতে পারলো না। Razu সম্পর্কে সহজ কিছু জিজ্ঞেস করো।",
    "✨ উঁহু, এইটা আমার এলাকায় পড়ে না। স্কিল, প্রজেক্ট বা কন্ট্যাক্ট ট্রাই করো।",
    "✨ থামো থামো, এইটা তো আমার সিলেবাসে নাই! Razu-র কাজ নিয়ে জিজ্ঞেস করো।",
    "✨ আমি একটা টার্মিনাল বট, ম্যাজিশিয়ান না! স্কিল বা প্রজেক্ট নিয়ে বলো।",
    "✨ এইটা শুনে আমার লোডিং স্পিনার ঘুরতেই থাকলো... কিছু বুঝলাম না।",
    "✨ Error 404: মাথায় ঢুকলো না! Razu-র এক্সপেরিয়েন্স বা এডুকেশন নিয়ে জিজ্ঞেস করো।",
    "✨ আমার কাছে এর উত্তর নাই, কিন্তু Razu-র প্রজেক্ট নিয়ে অনেক গল্প আছে!",
    "✨ হাহ? এইটা তো নতুন প্রশ্ন! স্কিল বা কন্ট্যাক্ট দিয়ে ট্রাই করো তো।",
    "✨ আমি চেষ্টা করলাম, কিন্তু এইটা আমার নাগালের বাইরে। Razu-র কাজ নিয়ে জিজ্ঞেস করো।",
    "✨ এইটা নিয়ে আমার কাছে কোনো ডেটা নাই, শুধু Razu-র স্কিল আর প্রজেক্ট নিয়ে আছে।",
    "✨ বুঝলাম না মামা, একটু ঘুরায়ে বলো তো!",
    "✨ এই প্রশ্নে আমি ব্ল্যাংক স্ক্রিন হয়ে গেলাম! স্কিল বা এক্সপেরিয়েন্স নিয়ে জিজ্ঞেস করো।",
    "✨ আমার নলেজ বেস এইটুকুই কভার করে না। Razu-র প্রজেক্ট নিয়ে জিজ্ঞেস করে দেখো।",
    "✨ থাম থাম, একটু সহজ ভাষায় বলো, আমি তো ছোট্ট বট!",
    "✨ এইটা শুনে আমার প্রসেসর হ্যাং করে গেছে। Razu-র স্কিল নিয়ে জিজ্ঞেস করো তো।",
    "✨ নাহ, এইটা আমার আওতায় নাই। কন্ট্যাক্ট বা রিজিউমি নিয়ে জিজ্ঞেস করলে হেল্প করতে পারি।",
    "✨ আমি Echo, সব জানি না, তবে Razu-র ব্যাপারে সব জানি!",
    "✨ এইটা তো ধাঁধা লাগলো! স্কিল, প্রজেক্ট বা এডুকেশন দিয়ে সহজ করো।",
    "✨ ওহহো, এই প্রশ্নটা আমার ট্রেনিং ডেটায় ছিল না! Razu-র কাজ নিয়ে জিজ্ঞেস করো।",
    "✨ আমার উত্তর খুঁজতে খুঁজতে কফি শেষ (যদিও বট কফি খায় না)। আবার সহজ করে বলো।",
    "✨ এইটা একদম নতুন প্রশ্ন, আমার কাছে উত্তর নাই। প্রজেক্ট বা স্কিল ট্রাই করো।",
    "✨ হুম, এই লাইনে আমি আটকে গেলাম। Razu-র এক্সপেরিয়েন্স নিয়ে জিজ্ঞেস করলে সহজ হবে।",
    "✨ সরি বস, এইটা আমার লিমিট ছাড়িয়ে গেছে। স্কিল, প্রজেক্ট বা কন্ট্যাক্ট নিয়ে বলো।",
    "✨ আমার সার্চ রেজাল্ট: শূন্য! Razu-র কাজ নিয়ে আবার জিজ্ঞেস করো।",
    "✨ এইটা তো আমার মাথার উপর দিয়ে গেলো (রূপক অর্থে, কারণ মাথা নাই)। সহজ প্রশ্ন করো।",
    "✨ আমি একটু কনফিউজড হয়ে গেলাম! স্কিল, প্রজেক্ট বা এডুকেশন নিয়ে জিজ্ঞেস করো তো।",
    "✨ এইটা নিয়ে আমি চুপ, কারণ জানিই না! Razu-র প্রজেক্ট বা কন্ট্যাক্ট ট্রাই করো।",
    "✨ আরে ভাই, এইটা তো আমার সিলেবাসের বাইরে! স্কিল বা এক্সপেরিয়েন্স নিয়ে বলো।",
    "✨ আমার কোডে এই প্রশ্নের কোনো if-else নাই! সহজ কিছু জিজ্ঞেস করো তো।",
    "✨ এইটা বুঝতে গিয়ে আমি লুপে আটকে গেলাম! Razu-র কাজ নিয়ে জিজ্ঞেস করো।",
    "✨ নাহ, এই টপিক আমার কাছে নাই রে ভাই। স্কিল, প্রজেক্ট বা কন্ট্যাক্ট ট্রাই করো।",
    "✨ আমি একটা ছোট্ট Echo বট, সব প্রশ্নের জবাব দিতে পারি না! Razu-র কাজ নিয়ে জিজ্ঞেস করো।",
    "✨ এই প্রশ্নে আমি টাসকি খেয়ে গেলাম! সহজ করে আবার বলো তো।",
    "✨ আমার মেমোরিতে এইটা সেভ নাই! স্কিল বা প্রজেক্ট দিয়ে ট্রাই করো।",
    "✨ হুমম, এইটা একটু কঠিন লাগলো আমার কাছে। Razu-র এডুকেশন বা এক্সপেরিয়েন্স নিয়ে জিজ্ঞেস করো।",
    "✨ সিরিয়াসলি, এইটা আমি জানি না! কন্ট্যাক্ট বা রিজিউমি নিয়ে জিজ্ঞেস করলে হেল্প করবো।",
    "✨ আমার উত্তর দেওয়ার ক্ষমতা এখানে সীমিত। Razu-র প্রজেক্ট নিয়ে জিজ্ঞেস করো, ভালো লাগবে।",
    "✨ এইটা তো একদম আনকমন প্রশ্ন! স্কিল, প্রজেক্ট বা কন্ট্যাক্ট দিয়ে চেষ্টা করো।",
    "✨ আমি বুঝলাম কিন্তু উত্তর নাই আমার কাছে। Razu-র কাজ নিয়ে জিজ্ঞেস করো তো।",
    "✨ এইটা শুনে আমার পিক্সেল কেঁপে উঠলো! সহজ প্রশ্ন করো, স্কিল বা প্রজেক্ট নিয়ে।",
    "✨ নট ফাউন্ড ইন মাই ব্রেইন! Razu-র এক্সপেরিয়েন্স বা এডুকেশন নিয়ে জিজ্ঞেস করো।",
    "✨ ধুর, এইটা তো একদম নতুন! স্কিল, প্রজেক্ট, এক্সপেরিয়েন্স বা কন্ট্যাক্ট নিয়ে জিজ্ঞেস করো।",
