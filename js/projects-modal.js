const PROJECTS_DATA = {
  "giftily": {
    ...
    tags: ["Flutter", "Riverpod", "GoRouter (navigation)", "Firebase (Fcm, Auth)", "Pusher", "REST API", "Dio + Retrofit", "Dart Isolate", "Isar (Local Storage)"],
  ...
  "lama": {
    ...
    tags: ["Flutter", "Riverpod", "Auto_Route (navigation)", "Dio + Retrofit", "CI/CD", "Firebase (Fcm, Auth)", "Objectbox (Local Storage)", "Google Map", "Pusher"],
  ...
  "agriwealth": {
    ...
    tags: ["Flutter", "Riverpod", "Firebase (Fcm, Auth)", "Hive (Local Storage)"],
  ...
  "listplace": {
    ...
    tags: ["Flutter", "Riverpod", "Pusher", "Google Map"],
    playStore: "",
    appStore: "",
  ...
  "coinectra": {
    ...
    tags: ["Flutter", "Provider", "Pusher", "REST API"],
    playStore: "",
    appStore: "",
  ...
  "waiz": {
    ...
    tags: ["Flutter", "Riverpod", "Pusher", "Hive (Local Storage)", "REST API", "Dio + Retrofit"],
    playStore: "",
    appStore: "",
  ...
  "paysecure-merchant": {
    ...
    tags: ["Flutter", "GetX", "Pusher", "Hive (Local Storage)"],
    playStore: "",
    appStore: "",
